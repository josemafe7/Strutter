        ...
        <s:if test="%{#session.usuario.tipo.equals('EMPLEADO') && !#session.datosUser.departamento.deptNo.equals(2)}">  
            ...
            <div class="w3-main" style="margin-left:300px;margin-top:43px;">
                ...
                <div class="w3-row-padding w3-margin-bottom w3-card-4 w3-padding-16 w3-margin w3-white">
                    <s:form namespace="/categorias" action="addCategoria">
                        <h4 class="w3-center"><s:text name="Nueva Categoria"/></h4>
                        <s:textfield cssClass="w3-input" name="categoria" label="Categoria"></s:textfield>


                        <s:submit cssClass="w3-button" name="addCategoria" value="Añadir categoria"></s:submit>
                    </s:form>
