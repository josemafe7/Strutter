...
<html>
    <head>
        ...
        <title>Strutter - Departamentos</title>
    ...
    <body class="w3-cyan">
        <s:if test="%{#session.usuario.tipo.equals('EMPLEADO') && #session.datosUser.departamento.deptNo.equals(1)}">   
            ...
            <div class="w3-main" style="margin-left:300px;margin-top:43px;">
                ...
                <div class="w3-row-padding w3-center w3-margin-bottom w3-card-4 w3-padding-16 w3-margin w3-white" style="overflow-x:auto;">
                    <h4 class="w3-center"><s:text name="- Departamentos -"/></h4>
                    <hr>
                    ...
                    <s:else>
                        <table border="0" style="border-collapse: collapse; margin:auto;">
                            ...
                            <s:iterator value="departamentos" var="departamento">
                                <tr>

                                    <td><s:property value="deptNo"/></td>
                                    <td><s:property value="deptNombre"/></td>
                                    <td><s:property value="deptDescripcion"/></td>
