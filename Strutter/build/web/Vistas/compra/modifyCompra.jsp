        ...
        <s:if test="%{#session.usuario.tipo.equals('EMPLEADO') && !#session.datosUser.departamento.deptNo.equals(2)}"> 
            ...
            <div class="w3-main" style="margin-left:300px;margin-top:43px;">
                ...
                <div class="w3-row-padding w3-margin-bottom w3-card-4 w3-padding-16 w3-margin w3-white">
                    <s:form namespace="/compras" action="modifyCompra">
                        <h4 class="w3-center"><s:text name="Modificar Compra"/></h4>

                        <s:text name="ID: "/><s:text name="%{idCompra}"/>
                        <s:hidden name="idCompra" value="%{idCompra}" />
                        <hr>
                        ...
                        <s:submit cssClass="w3-button" name="modifyCompra" value="Modificar compra"></s:submit>
                    </s:form>
