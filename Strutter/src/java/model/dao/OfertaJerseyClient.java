...
/**
 * Jersey REST client generated for REST resource:OfertaFacadeREST
 * [entidades.oferta]<br>
 * USAGE:
 * <pre>
 ...
 * @author Dani
 */
public class OfertaJerseyClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/Strutter_REST/webresources";

    public OfertaJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entidades.oferta");
    }
